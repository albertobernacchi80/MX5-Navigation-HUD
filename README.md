...
### Batteria: un'impostazione importante

Alcuni telefoni, con l'ottimizzazione batteria molto aggressiva, limitano le app che restano
in background — e Google Maps deve restare attivo in background mentre guardi l'HUD e non la
mappa, per continuare a generare le indicazioni che l'app legge. Se noti che le indicazioni
sull'HUD si bloccano o restano indietro mentre l'audio di Google Maps continua regolarmente,
vai su **Impostazioni del telefono > App > Google Maps > Batteria** e imposta **"Nessuna
restrizione"** (su alcuni telefoni si chiama "Non ottimizzare" o "Consenti attività in
background"). Va fatto una sola volta.
